<template>
    <div
        class="configurator-container container is-fluid"
        id="configurator-page"
    >
        <section class="configurator has-text-centered">
            ...
            <div class="columns">
                    ...
                    <div class="columns">
                        ...
                        <div class="column">
                            ...
                            >
                                ...
                                <img
                                    :src="
                                        tkaniny[tkaninyNumber].single_addon_url
                                    "
                                    v-show="!showKolnierz"
                                />
                                <img
                                    :src="
                                        tkaniny[tkaninyNumber]
                ...
                <div class="column" :class="columnSize">
                    ...
                    <div class="material-container" v-if="renderPodszewki">
                        <img
            ...
            <button
                class="button ready-button is-outlined"
                @click="makeOrder()"
            >
    ...
    methods: {
        ...
        makeOrder() {
            if (this.selected == "") {
                ...
                axios.put(
                    "/tkanina/" + String(this.tkaniny[this.tkaninyNumber].id),
                    {
                ...
                axios.put(
                    "/podszewka/" +
                        String(this.podszewki[this.podszewkiNumber].id),
                    {
                        quantity:
                            this.podszewki[this.podszewkiNumber].quantity - 1
                    }
                );
