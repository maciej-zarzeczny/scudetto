            ...
            <div class="add-image-section">
                <div class="file has-name">
                    <label class="file-label">
                        <input class="file-input" multiple type="file" name="resume" v-on:change="onImageChange">
                        <span class="file-cta">
    ...
    methods: {
        ...
        addNewPhotos() {
            if (this.uploadImages.length > 0) {
                ...
                this.uploadImagesNames[i] = "/images/gallery/" + (new Date).getTime() + i + '.png';
                }
                ...
                axios.post('/gallery', formData, config).then(response => {                
