  ...
  <div>
      ...
      <table class="table is-fullwidth">
        ...
        <tbody v-if="krojeReady">
          <tr v-for="(kroj, index) in kroje" :key="index">
            ...
            <td>{{ collar(kroj) }}</td>
            <td>
              <a class="button is-danger is-outlined" @click="deleteKroj(index)">
                <span>Usuń</span>
      ...
      <div class="add-section">
        <div class="file has-name">
          <label class="file-label">
            <input class="file-input" type="file" name="resume" v-on:change="onKrojChange" />
            <span class="file-cta">
        ...
        <div class="control">
          <button class="button is-primary" @click="addNewKroj()">Dodaj</button>
        </div>
      </div>
    </section>
    ...
    <section class="kroje-edit">
      <table class="table is-fullwidth">
        ...
        <tbody v-if="tkaninyReady">
          <tr v-for="(tkanina, index) in tkaniny" :key="index">
            <td>
              <figure class="image kroj-image">
                <img :src="tkanina.icon_url" alt="Material image" />
              </figure>
            </td>
            <td>{{ tkanina.name }}</td>
            ...
            <td>
              <p class="buttons">
                <a class="button is-info" @click="showTkaninaModal = true; choosedTkanina = index">
                  <span class="icon is-small">
                    <i class="far fa-edit"></i>
                  </span>
                  <span>Edytuj</span>
                </a>
                <a class="button is-danger is-outlined" @click="deleteTkanina(index)">
                  <span>Usuń</span>
                  <span class="icon is-small">
                    <i class="fas fa-times"></i>
                  </span>
      ...
      <div class="add-tkanina-section">
        <div class="control">
          <button
            ...
            @click="showAddTkaninaModal = true; newTkaninaAmount = 0"
          >Dodaj nową tkaninę</button>
        </div>
      </div>
      <!--------------------------------- 
                ADD TKANINA MODAL
      ...
      <div class="modal" :class="{ 'is-active' : showAddTkaninaModal }">
        ...
        <div class="modal-content">
          <table class="table is-fullwidth">
            ...
            <tbody>
              <tr>
                ...
                <td>
                  <label class="checkbox">
                    <input type="checkbox" v-model="femaleTkanina" />
                  </label>
                </td>
              </tr>
              <tr>
                ...
                <td class="update-controls">
                  <div class="file has-name">
                    <label class="file-label" @click="whichTkanina = 'icon'">
                      <input
                        class="file-input"
                        type="file"
                        name="resume"
              ...
              <tr v-for="(kroj, index) in kroje" :key="index">
                <td v-if="kroj.female == femaleTkanina">Przód ({{ kroj.name }} krój)</td>
                <td v-if="kroj.female == femaleTkanina" class="update-controls">
                  <div class="file has-name">
                    <label class="file-label" @click="whichTkanina = String(kroj.name)">
                      <input
                        class="file-input"
                        type="file"
                        name="resume"
              ...
              <tr>
                ...
                <td class="update-controls">
                  <div class="file has-name">
                    <label class="file-label" @click="whichTkanina = 'back'">
                      <input
                        class="file-input"
                        type="file"
                        name="resume"
              ...
              <tr>
                ...
                <td class="update-controls">
                  <div class="file has-name">
                    <label class="file-label" @click="whichTkanina = 'single_addon'">
                      <input
                        class="file-input"
                        type="file"
                        name="resume"
              ...
              <tr>
                ...
                <td class="update-controls">
                  <div class="file has-name">
                    <label class="file-label" @click="whichTkanina = 'collar_addon'">
                      <input
                        class="file-input"
                        type="file"
                        name="resume"
          ...
          <input class="input" type="tel" placeholder="Ilość" v-model="newTkaninaAmount" />
          <div class="control">
            <button class="button is-primary" @click="addTkaninaAmount()">Zapisz</button>
          </div>
        </div>
        <button
        ...
        <div class="modal-content">
          <table class="table is-fullwidth">
            ...
            <tbody>
              <tr>
                <td></td>
                <td>{{ tkaniny[choosedTkanina].female == 1 ? 'Damska' : 'Męska' }}</td>
              </tr>
              <tr>
                <td>
                  <figure class="image kroj-image">
                    <img :src="tkaniny[choosedTkanina].icon_url" alt="Material icon" />
                  </figure>
                </td>
                <td>Ikona</td>
                <td class="update-controls">
                  <div class="file has-name">
                    <label class="file-label" @click="whichTkanina = 'icon'">
                      ...
                      <span class="file-cta">
                        ...
                        <span class="file-label">Wybierz zdjęcie...</span>
                      </span>
                    </label>
                  </div>
                </td>
              ...
              <tr v-for="(kroj, index) in kroje" :key="index">
                <td v-if="tkaniny[choosedTkanina].female == kroj.female">
                  <figure class="image kroj-image">
                    <img
                      v-if="tkaniny[choosedTkanina].female == 1"
                      :src="'/images/creator/female/' + kroj.name + '/' + tkaniny[choosedTkanina].name + '.png'"
                      alt="Material icon"
                    />
                    <img
                      v-if="tkaniny[choosedTkanina].female == 0"
                      :src="'/images/creator/' + kroj.name + '/' + tkaniny[choosedTkanina].name + '.png'"
                      alt="Material icon"
                    />
                  </figure>
                </td>
                <td
                  v-if="tkaniny[choosedTkanina].female == kroj.female"
                >Przód ({{ kroj.name }} krój)</td>
                <td v-if="tkaniny[choosedTkanina].female == kroj.female" class="update-controls">
                  <div class="file has-name">
                    <label class="file-label" @click="whichTkanina = String(kroj.name)">
                      <input
                        class="file-input"
              ...
              <tr>
                <td>
                  <figure class="image kroj-image">
                    <img :src="tkaniny[choosedTkanina].back_image_url" alt="Material icon" />
                  </figure>
                </td>
                <td>Tył</td>
                <td class="update-controls">
              ...
              <tr>
                <td>
                  <figure class="image kroj-image">
                    <img :src="tkaniny[choosedTkanina].single_addon_url" alt="Material icon" />
                  </figure>
                </td>
                <td>Pasek</td>
                <td class="update-controls">
              ...
              <tr>
                <td>
                  <figure class="image kroj-image">
                    <img :src="tkaniny[choosedTkanina].addon_with_collar_url" alt="Material icon" />
                  </figure>
                </td>
                <td>Pasek z kołnierzem</td>
                <td class="update-controls">
          ...
          />
          <div class="control">
            <button class="button is-primary" @click="updateTkaninaAmount()">Zapisz</button>
          </div>
        </div>
        <button class="modal-close is-large" aria-label="close" @click="showTkaninaModal = false"></button>
      </div>
    </section>
    ...
    <section class="kroje-edit">
      <table class="table is-fullwidth">
        ...
        <tbody v-if="podszewkiReady">
          <tr v-for="(podszewka, index) in podszewki" :key="index">
            <td>
              <figure class="image kroj-image">
                <img :src="podszewka.icon_url" alt="Material image" />
              </figure>
            </td>
            ...
            <td>
              <p class="buttons">
                <a
                  ...
                  @click="showPodszewkaModal = true; choosedPodszewka = index"
                >
                  <span class="icon is-small">
                    <i class="far fa-edit"></i>
                  </span>
                ...
                <a class="button is-danger is-outlined" @click="deletePodszewka(index)">
                  <span>Usuń</span>
                  <span class="icon is-small">
                    <i class="fas fa-times"></i>
                  </span>
      ...
      <div class="add-podszewki-section">
        <div class="control">
          <button
            class="button is-primary"
            @click="showAddPodszewkaModal = true; newPodszewkaAmount = 0"
          >Dodaj nową podszewkę</button>
        </div>
      </div>
      <!--------------------------------- 
                ADD PODSZEWKA MODAL
      ...
      <div class="modal" :class="{ 'is-active' : showAddPodszewkaModal }">
        ...
        <div class="modal-content">
          <table class="table is-fullwidth">
            ...
            <tbody>
              <tr>
                ...
                <td class="update-controls">
                  <div class="file has-name">
                    <label class="file-label" @click="whichPodszewka = 'icon'">
                      <input
                        class="file-input"
                        type="file"
                        name="resume"
              ...
              <tr>
                ...
                <td class="update-controls">
                  <div class="file has-name">
                    <label class="file-label" @click="whichPodszewka = 'front'">
                      <input
                        class="file-input"
                        type="file"
                        name="resume"
              ...
              <tr>
                ...
                <td class="update-controls">
                  <div class="file has-name">
                    <label class="file-label" @click="whichPodszewka = 'back'">
                      <input
                        class="file-input"
                        type="file"
                        name="resume"
              ...
              <tr>
                ...
                <td class="update-controls">
                  <div class="file has-name">
                    <label class="file-label" @click="whichPodszewka = 'back_female'">
                      <input
                        class="file-input"
                        type="file"
                        name="resume"
          ...
          <input class="input" type="tel" placeholder="Ilość" v-model="newPodszewkaAmount" />
          <div class="control">
            <button class="button is-primary" @click="addPodszewkaAmount()">Zapisz</button>
          </div>
        </div>
        <button
          class="modal-close is-large"
      ...
      >
        ...
        <div class="modal-content">
          <table class="table is-fullwidth">
            ...
            <tbody>
              <tr>
                <td>
                  <figure class="image kroj-image">
                    <img :src="podszewki[choosedPodszewka].icon_url" alt="Material icon" />
                  </figure>
                </td>
                <td>Ikona</td>
                <td class="update-controls">
              ...
              <tr>
                <td>
                  <figure class="image kroj-image">
                    <img :src="podszewki[choosedPodszewka].image_url" alt="Material icon" />
                  </figure>
                </td>
                <td>Przód</td>
                <td class="update-controls">
              ...
              <tr>
                <td>
                  <figure class="image kroj-image">
                    <img :src="podszewki[choosedPodszewka].back_image_url" alt="Material icon" />
                  </figure>
                </td>
                <td>Tył</td>
                <td class="update-controls">
              ...
              <tr>
                <td>
                  <figure class="image kroj-image">
                    <img
                      :src="podszewki[choosedPodszewka].back_female_image_url"
                      alt="Material icon"
                    />
                  </figure>
                </td>
          ...
          />
          <div class="control">
            <button class="button is-primary" @click="updatePodszewkaAmount()">Zapisz</button>
          </div>
        </div>
        <button class="modal-close is-large" aria-label="close" @click="showPodszewkaModal = false"></button>
      </div>
    </section>
    <!--------------------------------- 
             GUZIKI 
    ...
    <section class="kroje-edit">
      <table class="table is-fullwidth">
        ...
        <tbody v-if="guzikiReady">
          <tr v-for="(guzik, index) in guziki" :key="index">
            <td>
              <figure class="image kroj-image">
                <img :src="guzik.icon_url" alt="Material image" />
              </figure>
            </td>
            <td>{{ guzik.name }}</td>
            <td>{{ female(guzik) }}</td>
            <td>
              <p class="buttons">
                <a class="button is-info" @click="showGuzikiModal = true; choosedGuziki = index">
                  <span class="icon is-small">
                    <i class="far fa-edit"></i>
                  </span>
                  <span>Edytuj</span>
                </a>
                <a class="button is-danger is-outlined" @click="deleteGuziki(index)">
                  <span>Usuń</span>
                  <span class="icon is-small">
                    <i class="fas fa-times"></i>
                  </span>
      ...
      <div class="add-guziki-section">
        <div class="control">
          <button class="button is-primary" @click="showAddGuzikiModal = true">Dodaj nowe guziki</button>
        </div>
      </div>
      <!--------------------------------- 
                ADD GUZIKI MODAL
      ...
      <div class="modal" :class="{ 'is-active' : showAddGuzikiModal }">
        ...
        <div class="modal-content">
          <table class="table is-fullwidth">
            ...
            <tbody>
              <tr>
                ...
                <td>
                  <label class="checkbox">
                    <input type="checkbox" v-model="femaleGuziki" />
                  </label>
                </td>
              </tr>
              <tr>
                ...
                <td class="update-controls">
                  <div class="file has-name">
                    <label class="file-label" @click="whichGuziki = 'icon'">
                      <input
                        class="file-input"
                        type="file"
                        name="resume"
              ...
              <tr v-for="(kroj, index) in kroje" :key="index">
                <td v-if="femaleGuziki == kroj.female">Guziki ({{ kroj.name }} krój)</td>
                <td v-if="femaleGuziki == kroj.female" class="update-controls">
                  <div class="file has-name">
                    <label class="file-label" @click="whichGuziki = String(kroj.name)">
                      <input
                        class="file-input"
                        type="file"
                        name="resume"
          ...
          <div class="control">
            <button class="button is-primary" @click="addGuziki()">Zapisz</button>
          </div>
        </div>
        <button class="modal-close is-large" aria-label="close" @click="showAddGuzikiModal = false"></button>
      </div>
      <!--------------------------------- 
                EDIT GUZIKI MODAL 
      ----------------------------------->
      ...
      >
          ...
          <table class="table is-fullwidth">
            ...
            <tbody>
              ...
              <tr>
                <td>
                  <figure class="image kroj-image">
                    <img :src="guziki[choosedGuziki].icon_url" alt="Material icon" />
                  </figure>
                </td>
                <td>Ikona</td>
                <td class="update-controls">
              ...
              <tr v-for="(kroj, index) in kroje" :key="index">
                <td v-if="kroj.female == guziki[choosedGuziki].female">
                  <figure class="image kroj-image">
                    <img
                      v-if="guziki[choosedGuziki].female == 1"
                      :src="'/images/creator/female/' + kroj.name + '/' + guziki[choosedGuziki].name + '.png'"
                      alt="Material icon"
                    />
                    <img
                      v-if="guziki[choosedGuziki].female == 0"
                      :src="'/images/creator/' + kroj.name + '/' + guziki[choosedGuziki].name + '.png'"
                      alt="Material icon"
                    />
                  </figure>
                </td>
                <td v-if="kroj.female == guziki[choosedGuziki].female">Guziki ({{ kroj.name }} krój)</td>
                <td v-if="kroj.female == guziki[choosedGuziki].female" class="update-controls">
                  <div class="file has-name">
                    <label class="file-label" @click="whichGuziki = String(kroj.name)">
                      <input
                        class="file-input"
        ...
        <button class="modal-close is-large" aria-label="close" @click="showGuzikiModal = false"></button>
      </div>
    </section>
  </div>
</template>
    ...
    addPodszewkaAmount() {
      ...
      axios
        .post("podszewka", {
          ...
          back_image_url: "/images/creator/" + podszewkaName + "p.png",
