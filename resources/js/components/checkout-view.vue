...
export default {
    ...
    mounted() {
        ...
        if (localStorage.getItem("coupon") != null) {
            this.discount = JSON.parse(localStorage.getItem("coupon")).discount;
            if (this.discount == 100) this.shippingMethod = "3";
        }
    }
};
</script>
