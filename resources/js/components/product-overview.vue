            ...
            <div class="columns">
                <div class="column">
                    <figure class="image is-centered is-pulled-right">
                        ...
                        <div style="product-image">
                            <zoom-on-hover :img-normal="imageSrc" :scale="2">
                                ></zoom-on-hover
                            >
                        </div>
                        <button
                ...
                <div class="column">
                    ...
                    <div
                        class="prices"
                        v-if="isVoucher && voucherPrice != null"
                    >
                        <strong
                    ...
                    <p class="product-description">
                        {{
                            lang == "pl"
                                ...
                                : product.shortEnglishDescription
                        }}
                    </p>
                    ...
                    <div class="quantity-container">
                        ...
                        <span
                            class="tag added-to-cart-tag"
                            :class="{ 'added-to-cart-active': addedToCart }"
                        >
                    ...
                    <div class="tabs is-boxed description-tabs">
                        <ul>
                            <li
                                :class="{ 'is-active': activeTabs[0] }"
                                @click="changeTab(0)"
                            >
                                <a>{{ $t("messages.product_description") }}</a>
                            </li>
                            <li
                                :class="{ 'is-active': activeTabs[1] }"
                                @click="changeTab(1)"
                            >
                                <a>{{ $t("messages.product_materials") }}</a>
                            </li>
                        </ul>
                    </div>
...
export default {
    ...
    created() {
        ...
        this.sizes.sort((a, b) => {
            var sizeA = a.sizeName.toLowerCase(),
                sizeB = b.sizeName.toLowerCase();
