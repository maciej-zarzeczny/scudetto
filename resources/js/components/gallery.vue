<template>
    <section class="section gallery" id="gallery">
        ...
        <div v-if="imagesReady">
            <div class="columns" v-for="index in Math.ceil(images.length / 4)" :key="index">
                <div class="column" v-for="columnIndex in 4" :key="columnIndex">
                    <figure class="image gallery-image">
                        <img :src="images[imageIndex].url" alt="Gallery image" v-show="renderImage" v-once @click="showBigPhoto(index, columnIndex, 1)">
                    </figure>
                    {{ renderGallery(1) }}
                </div>
            </div>
            
            <div class="icon-parent" v-show="!showMorePhotos" @click="getMorePhotos()" v-if="images.length == 8">
        ...
        <div v-if="showMorePhotos">
            <div class="columns" v-for="index in Math.ceil(hiddenImages.length / 4)" :key="index">
                <div class="column" v-for="columnIndex in 4" :key="columnIndex">
                    <figure class="image gallery-image">
                        <img :src="hiddenImages[hiddenImagesIndex].url" alt="Gallery image" v-show="renderHiddenImage" v-once @click="showBigPhoto(index, columnIndex, 2)">
                    </figure>
                    {{ renderGallery(2) }}
                </div>
            </div>
